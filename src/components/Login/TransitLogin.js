...
const TransitLogin = (props) => {
  ...
  const validateUser = () => {
    ...
    axios.post(process.env.REACT_APP_API_URL+'/transit_login', {username: loginState.email, password: loginState.password}).then(res => {
    ...
    }).catch(err => {toast.error('server timed out')})
    ...
    <div className="Auth-form-container">
      <form className="Auth-form">
        <div className="Auth-form-content">
          <h3 className="Auth-form-title">Transit Sign In</h3>
